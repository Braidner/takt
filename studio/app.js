...
const RU = {
  ...
  cardSlate: "Заставка",
  cardOn: "Показывать",
  zoomIn: "Приблизить шкалу",
  linkLost: "Связь со студией потеряна — переподключаюсь",
  linkBack: "Связь восстановлена",
  nowYou: "ваш ход",
  actShoot: "Снимать",
  actCut: "Собрать ролик",
  actApply: "Применить замечания",
  nowAgent: "агент",
  now_task: "Опишите словами, что показать в ролике",
  now_approve: "Проверьте раскадровку и нажмите «Снимать»",
  now_shoot: "Не снято планов: {count} — нажмите «Снимать»",
  now_failed: "План «{plan}» не снялся: {why}",
  now_build: "Материал снят — соберите ролик",
  now_reshoot: "Раскадровка изменилась — переснимите планы",
  now_rebuild: "Правки внесены — пересоберите ролик",
  now_notes: "Замечаний: {count} — примените их или добавьте ещё",
  now_watch: "Посмотрите ролик и оставьте замечания по таймкодам",
  doing_task: "Собираю раскадровку",
  doing_shoot: "Снимаю",
  doing_cut: "Собираю ролик",
  doing_short: "Собираю короткую версию",
  doing_apply: "Применяю замечания",
  doing_regen: "Пересобираю раскадровку",
  doing_retake: "Переснимаю",
  doing_note: "Принимаю замечание",
  doing_narrate: "Озвучиваю",
  sendNow: "Уйдёт агенту сразу",
  sendQueued: "Агент не на связи — замечание подождёт его в очереди",
  versionCheck: "Проверить обновления",
  versionChecking: "смотрю…",
  versionUpdating: "обновляю…",
  versionUnknown: "версия неизвестна",
  versionBlocked: "В каталоге кода локальные правки — обновление их затрёт. Сначала разберитесь с ними.",
  versionConfirm: "Обновить Takt? Студия перезапустится.",
  screenSize: "Размер экрана в кадре",
  screenSmaller: "Уменьшить экран в кадре",
  screenBigger: "Увеличить экран в кадре",
  zoomOut: "Отдалить шкалу",
  cardSub: "Подзаголовок",
  cardUrl: "Ссылка",
  cardSeconds: "Длительность",
  cardOff: "выключена",
  cardTitleSlate: "Заставка",
  cardTitleEnd: "Финальная плашка",
  ...
  durShot: "Длина снятой записи: живое движение не растянуть",
  fx_push: "наезд",
  fx_pan: "панорама",
  fx_drift: "дрейф",
  ...
  toolWedge: "вставка",
  toolWedgeTitle: "Отдельный план со своей графикой — встанет следом за этим",
  wedgeTitle: "Вставка",
  planInsert: "вставка",
  fxFile: "Файл",
  fxRate: "Темп",
  ...
  stageDraft: "{stage}: черновик",
  stageReady: "{stage}: готово",
  stageStale: "{stage}: устарело после правки выше по цепочке",
  statusReady: "утверждена",
  statusReadyTitle: "Съёмка по ней стартует. Нажмите, чтобы вернуть в черновик",
  statusDraftTitle: "Черновик: съёмка не стартует. Нажмите, чтобы утвердить",
  statusUnapprove: "Снять утверждение? Съёмка по этой раскадровке не стартует, пока не утвердите снова.",
...
const EN = {
  ...
  cardOn: "Show",
  zoomIn: "Zoom in",
  linkLost: "Lost the studio connection — reconnecting",
  linkBack: "Connection restored",
  nowYou: "your turn",
  actShoot: "Shoot",
  actCut: "Build the video",
  actApply: "Apply notes",
  nowAgent: "agent",
  now_task: "Describe what the video should show",
  now_approve: "Review the storyboard and press Shoot",
  now_shoot: "{count} plans not shot — press Shoot",
  now_failed: "Plan “{plan}” failed: {why}",
  now_build: "Footage captured — build the video",
  now_reshoot: "Storyboard changed — reshoot the plans",
  now_rebuild: "Edits applied — rebuild the video",
  now_notes: "{count} notes — apply them or add more",
  now_watch: "Watch the video and leave notes by timecode",
  doing_task: "Building the storyboard",
  doing_shoot: "Shooting",
  doing_cut: "Building the video",
  doing_short: "Building the highlights",
  doing_apply: "Applying notes",
  doing_regen: "Rebuilding the storyboard",
  doing_retake: "Reshooting",
  doing_note: "Taking the note",
  doing_narrate: "Narrating",
  sendNow: "Goes to the agent right away",
  sendQueued: "Agent is offline — the note waits in the queue",
  versionCheck: "Check for updates",
  versionChecking: "checking…",
  versionUpdating: "updating…",
  versionUnknown: "version unknown",
  versionBlocked: "The code directory has local changes — an update would wipe them. Deal with those first.",
  versionConfirm: "Update Takt? The studio will restart.",
  screenSize: "App window size in frame",
  screenSmaller: "Smaller app window",
  screenBigger: "Larger app window",
  zoomOut: "Zoom out",
  cardSub: "Subtitle",
  cardUrl: "Link",
  cardSeconds: "Duration",
  cardOff: "off",
  cardTitleSlate: "Title card",
  cardTitleEnd: "End card",
  cardEnd: "End card",
  ...
  durShot: "Length of the recorded take: live motion cannot be stretched",
  fx_push: "push in",
  fx_pan: "pan",
  fx_drift: "drift",
  fx_closeup: "close-up",
  ...
  toolInsert: "insert",
  toolWedge: "wedge",
  toolWedgeTitle: "A plan of its own with your graphic — goes right after this one",
  wedgeTitle: "Wedge",
  planInsert: "wedge",
  fxFile: "File",
  ...
  statusReadyTitle: "Shooting can start. Click to send back to draft",
  statusDraftTitle: "Draft: shooting will not start. Click to approve",
  statusUnapprove: "Send back to draft? Shooting will not start until you approve again.",
  statusDraft: "draft",
  shootRun: "Record",
