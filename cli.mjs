...
const COMMANDS = {
  ...
  storyboard:{ file: 'studio/storyboard.mjs', help: 'отправить раскадровку в студию', studio: true },
  shoot:    { file: 'studio/shoot.mjs',       help: 'снять по утверждённой раскадровке', studio: true },
  build:    { file: 'studio/build.mjs',       help: 'собрать ролик композицией из снятых состояний', studio: true },
  edit:     { file: 'studio/edit.mjs',        help: 'то же, что build: монтаж живёт в композиции', studio: true },
