...
const COMMANDS = {
  ...
  build:    { file: 'studio/build.mjs',       help: 'собрать мастер из последнего дубля', studio: true },
  edit:     { file: 'studio/edit.mjs',        help: 'смонтировать: камера, курсор, титры, звук', studio: true },
